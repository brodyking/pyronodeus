...
<section class="my">
  ...
  if ($rank === false){
    ...
    echo '	<section>
                ...
                </h2><div class="center"><form method="post" action="admin.php"><label style="display: none;">Mod Username (blank for admins): <input type="text" name="username"></label>
    <label>Password: <input required type="password" name="password"></label> <input type="submit" value="Login"><input type="hidden" name="csrf" value="' . $CSRF . '"></form></div>';
  }
  elseif ($rank !== false){
    // admin or moderator
