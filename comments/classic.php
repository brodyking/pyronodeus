...
?>
	...
	?>		<section>
                ...
                <table><tbody>	<div class='postForm'>
		<form method='post' action='submit.php'>
		            <tr><td>Title</td><td><input required type='text' name='title' maxlength='20'></td></tr>
		            <tr><td>Name</td><td><input required type='text' name='name' maxlength='20' value='Anonymous'></td></tr>
		            <tr><td>Tripcode</td><td><input type='password' name='tripcode' maxlength='100' placeholder='optional'><input type='hidden' name='CSRF' value='<?php echo $CSRF;?>'></td></tr>
			...
			?>
		            <tr><td>Submit</td><td><input type='submit' value='Post' class='submitPostButton'></td></tr>
            		</form>
		        </div></tbody></table>
